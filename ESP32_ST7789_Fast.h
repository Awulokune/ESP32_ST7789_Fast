...
#ifndef _ESP32_ST7789_FAST_H_
#define _ESP32_ST7789_FAST_H_
...
class ESP32_ST7789_Fast : public Adafruit_GFX {

 public:
  ESP32_ST7789_Fast(int8_t DC, int8_t RST, int8_t CS = -1, int8_t SCLK = 18, int8_t MOSI = 23);
 ...
 protected:
  ...
  void beginWrite();
  void endWrite();
  void setSPIPins(int8_t SCLK, int8_t MOSI);

 private:
  int8_t  csPin, dcPin, rstPin, sclkPin, mosiPin;
